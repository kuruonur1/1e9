...
#$ -cwd
#$ -o /dev/null
#$ -e /mnt/kufs/scratch/{}/1e9/job.err
#$ -M {}@ku.edu.tr
#$ -m bea
 
source ~/setenv.sh
cd /mnt/kufs/scratch/{}/1e9
MKL_NUM_THREADS={} THEANO_FLAGS=mode=FAST_RUN,device={},floatX=float32 python {}.py {}
"""

if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog="creatjob")
    parser.add_argument("--p", action='store_true', help='just print, dont submit') 
    parser.add_argument("--script", default='optmain')
